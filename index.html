...
<body>
	...
	<section id="home" class="tt-fullHeight" data-stellar-vertical-offset="50" data-stellar-background-ratio="0.2">
		<div class="intro">
			<div class="intro-sub">I am Abhinav</div>
				<h1>DevOps<span>Engineer</span></h1>
			<p>I am a passionate Learner with skills sets in different domains like cybersecurity,Web Development, Netwroking,etc.&amp;<br> Currently working as MLOps and DevOps intern in LinuxWorld Informatical Pvt Ltd. <br> Feel free to contact me for any help.</p>
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-md-push-8">
            <div class="biography">
              ...
              <ul>
                <li><strong>Name:</strong> Abhinav Dubey</li>
                <li><strong>Date of birth:</strong> 26 April 2000</li>
                <li><strong>Address:</strong> 239/2 Awesome Street, India</li>
                <li><strong>Nationality:</strong> Indian</li>
                <li><strong>Phone:</strong> (000) 1234 56789</li>
                <li><strong>Email:</strong> xxxmail@iamx.com</li>
              </ul>
            </div>
          </div> <!-- col-md-4 -->
